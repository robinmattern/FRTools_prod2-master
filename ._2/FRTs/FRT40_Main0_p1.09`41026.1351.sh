...
##FD   FRT10_Main0.sh           |  38720| 10/26/24  1:50|   584| p1.09`41026.1350
##DESC     .--------------------+-------+---------------+------+-----------------+
...
# .(41026.04 10/26/24 RAM 13:50p| Fix JPT12_Main2Fns_p1.07 & dokR location
...
#       echo   "  - FRT10[305]  JPT: JPT00_Main0.sh   ${aSubCmd} \"$@\""; exit
