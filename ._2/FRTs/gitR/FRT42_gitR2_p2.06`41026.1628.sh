...
##FD   FRT22_gitR1.sh           | 118423| 10/26/24 16:40|  1817| p2.06-41016.1640
##DESC     .--------------------+-------+---------------+------+-----------------+
...
#       aFns="$( dirname "${BASH_SOURCE}")/../../JPTs/JPT12_Main2Fns_p1.07.sh"; if [ ! -f "${aFns}" ]; then # .(21113.05.7 RAM Use JPT12_Main2Fns_p1.07.sh)
        aFns="$( dirname "${BASH_SOURCE}"           )/JPT12_Main2Fns_p1.07.sh"; if [ ! -f "${aFns}" ]; then # .(41026.04.5 RAM Use copy in FRTs).(21113.05.9 RAM Use FRT12_Main2Fns_p1.06_v21027.sh)
...
#       echo "  - gitR1[153]  aOSv: ${aOSv}, ${aOS}, aLstSp: '${aLstSp}'"; ${aLstSp}; # exit
