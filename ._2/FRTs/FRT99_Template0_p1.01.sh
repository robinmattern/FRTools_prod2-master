...
##FD   FRT99_Template0.sh       |  10584| 10/27/24 19:35|   173| p1.01-41027.1935
##DESC     .--------------------+-------+-----------------+------+---------------+
...
# .(41027.01 10/27/24 RAM  7:35p| Fix JPT12_Main2Fns_p1.07
...
#========================================================================================================== #  ===============================  #
        ...
        LIB=DOC; LIB_LOG=${DOC}_LOG; LIB_USER=${LIB}_USER; aDir=$( dirname "${BASH_SOURCE}" );              # .(41027.01.9 RAM).(80923.01.1)

        aFns="$( dirname "${BASH_SOURCE}" )/../JPTs/JPT12_Main2Fns_p1.07.sh";  if [ ! -f "${aFns}" ]; then  # .(21113.05.9 RAM Use JPT12_Main2Fns_p1.07.sh).(41027.01.5)
                            aFns="${aDir/FRTs/}JPTs/JPT12_Main2Fns_p1.07.sh";  if [ ! -f "${aFns}" ]; then  # .(41027.01.5)
