...
##FD   FRT30_docR0.sh           |  20264| 10/27/24 19:30|   334| p1.01-41027.1930
##DESC     .--------------------+-------+-----------------+------+---------------+
...
# .(41027.01 10/27/24 RAM  7:30p| Fix JPT12_Main2Fns_p1.07
...
#========================================================================================================== #  ===============================  #
        ...
        LIB=DOC; LIB_LOG=${DOC}_LOG; LIB_USER=${LIB}_USER; aDir=$( dirname "${BASH_SOURCE}" );              # .(41027.01.8 RAM).(80923.01.1)
...
#       aFns="$( dirname "${BASH_SOURCE}" )/../JPTs/JPT12_Main2Fns_p1.07.sh";  if [ ! -f "${aFns}" ]; then  ##.(21113.05.9 RAM Use JPT12_Main2Fns_p1.07.sh).(41026.04.4).(41027.01.4)
#       aFns="$( dirname "${BASH_SOURCE}" )/../JPTs/JPT12_Main2Fns_p1.07.sh";  if [ ! -f "${aFns}" ]; then  ##.(41026.04.1).(41027.01.4)
                            aFns="${aDir/FRTs/}JPTs/JPT12_Main2Fns_p1.07.sh";  if [ ! -f "${aFns}" ]; then  # .(41027.01.4).(41026.04.1)
